...
Allows Gunter to learn from user feedback like:
...
if TYPE_CHECKING:
    ...
    from gunter.reasoning.confidence import ConfidenceScorer, ScoredAnswer
...
class FeedbackLearner:
    ...
    def suggest_knowledge_gaps(self) -> str:
        """Suggest areas where Gunter needs more knowledge.
