...
Given a matched pattern type and extracted entities, searches PRISM's
...
from prism.reasoning.pattern_library import PatternType
...
class VSAReasoner:
    """Execute reasoning patterns over PRISM's knowledge base.
    ...
    def _check_transitive(
        ...
        chain = self.engine.transitive.infer(subject, obj)
