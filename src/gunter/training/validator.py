...
if TYPE_CHECKING:
    from gunter.training.fact_extractor import ExtractedFact
...
class FactValidator:
    """Validate facts before storing in Gunter's memory.
    ...
    def __init__(self, gunter: Any = None) -> None:
        self.gunter = gunter
    ...
    def _check_consistency(self, fact: Any) -> tuple[bool, str]:
        ...
        try:
            conflicts = self.gunter.contradiction.check(
